...
const PrizeMobile = ({reversePitch}) => {
    ...
    return (
        <>
            <div className='text-[50px] font-medium flex flex-col justify-center items-center gap-4 px-6 py-10'>
                                        ...
                                        <ul className=' text-[26px] pl-5 '>
                                            {
                                                item?.List?.map((prize, key) => (
                                                    <li className=' flex-col items-start flex list-disc ' key={key}><span className='font-bold'>{item.category} {prize.heading}</span>
                                                        {
